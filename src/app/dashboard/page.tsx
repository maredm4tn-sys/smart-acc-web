...
import { Activity, CreditCard, DollarSign, Users, Package, TrendingUp, AlertTriangle, Calendar, Plus, FileText, ShoppingCart } from "lucide-react";
import { db } from "@/db";
...
export default async function DashboardPage() {
    ...
    if (isCashier) {
        ...
        return (
            <div className="space-y-8">
                ...
                {/* Cashier Specific Quick Actions (Big Buttons) */}
    ...
    try {
        ...
        console.warn("DB Connection failed, showing empty state");
    }
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white border border-slate-100 p-6 shadow-sm hover:shadow-md transition-all duration-300 group">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 group-hover:scale-110 transition-transform duration-300">
                            <DollarSign className="h-5 w-5" />
                        </div>
                        <h3 className="text-sm font-medium text-slate-500">{dict.Dashboard.TotalRevenue}</h3>
                    </div>
                    <div className="mt-4 flex items-baseline gap-1">
                        <span className="text-3xl font-bold tracking-tight text-slate-900">{Number(stats.totalRevenue).toLocaleString()}</span>
                    ...
                    <div className="mt-4 flex items-center gap-2 text-xs font-medium text-slate-600">
                        ...
                        <span className="text-slate-400">{dict.Dashboard.CompareLastMonth}</span>
                    </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white border border-slate-100 p-6 shadow-sm hover:shadow-md transition-all duration-300 group">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="mt-4">
                        <h3 className="text-sm font-medium text-slate-500">{dict.Dashboard.SalesInvoices}</h3>
                        <div className="mt-2 flex items-baseline gap-2">
                            <span className="text-2xl font-bold text-slate-900">{stats.invoicesCount}</span>
                            <span className="text-xs text-slate-400">{dict.Dashboard.Invoice}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white border border-slate-100 p-6 shadow-sm hover:shadow-md transition-all duration-300 group">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="mt-4">
                        <h3 className="text-sm font-medium text-slate-500">{dict.Dashboard.ActiveProducts}</h3>
                        <div className="mt-2 flex items-baseline gap-2">
                            <span className="text-2xl font-bold text-slate-900">{stats.activeProducts}</span>
                            <span className="text-xs text-slate-400">{dict.Dashboard.Item}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white border border-slate-100 p-6 shadow-sm hover:shadow-md transition-all duration-300 group">
                    <div className="flex items-center justify-between">
                        <div className="h-10 w-10 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover:scale-110 transition-transform duration-300">
                            <Activity className="h-5 w-5" />
                        </div>
                    </div>
                    <div className="mt-4">
                        <h3 className="text-sm font-medium text-slate-500">{dict.Dashboard.FinancialAccounts}</h3>
                        <div className="mt-2 flex items-baseline gap-2">
                            <span className="text-2xl font-bold text-slate-900">{stats.totalAccounts}</span>
                            <span className="text-xs text-slate-400">{dict.Dashboard.Account}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-7">
                ...
                {/* Revenue Chart - Taking more width */}
                <RevenueChart />
