    ...
    if (type === 'thermal') {
        return (
            <div className="bg-white min-h-screen text-black font-mono font-bold" style={{ width: '80mm', margin: '0 auto', padding: '8mm' }}>
                ...
                <div className="text-[12px] space-y-1 my-3" dir="rtl">
                ...
                <div className="flex text-[11px] pb-1 font-black" dir="rtl">
                    <span className="w-10 text-right">الكمية</span>
                    <span className="flex-1 px-1 text-right">الصنف</span>
                ...
                <div className="space-y-2 mb-4" dir="rtl">
                    {items.map((item, i) => (
                        <div key={i} className="flex text-[12px] items-start border-b border-gray-100 pb-1">
                            <span className="w-10 text-right">{Number(item.quantity)}</span>
                            <span className="flex-1 px-1 leading-tight text-right">{item.description}</span>
                ...
                <div className="border-t-2 border-dashed border-black my-2" />
                <div className="text-[12px] space-y-1" dir="rtl">
                ...
                <div className="flex justify-between items-center text-xl py-1 font-black" dir="rtl">
                    <span>الإجمالي:</span>
