            ...
            <div className="h-20 flex items-center px-6 border-b border-gray-100 justify-between">
                ...
                {onClose && (
                    <button
                        ...
                        title={(dict as any).Common?.Close || "Close"}
                        aria-label={(dict as any).Common?.Close || "Close"}
                    >
                        <X size={20} />
                    </button>
                )}
            ...
            <nav className="flex-1 p-4 space-y-1 mt-4 overflow-y-auto custom-scrollbar">
                ...
                {isAdmin && (
                    <>
                        ...
                        <SidebarItem href="/dashboard/vouchers" icon={<Receipt size={20} />} label={(dict as any).Vouchers?.Title || "سندات القبض والصرف"} onClick={onClose} />
                        ...
                        <SidebarItem href="/dashboard/pos" icon={<LayoutDashboard size={20} />} label={dict.Sidebar.POS || "Point of Sale (POS)"} onClick={onClose} />
